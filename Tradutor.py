...
def main():
    ...
    for index, i in enumerate(tok):
        ...
        if(i == 'main'):
            ...
            tradutor.append('DSVF L2')

        elif(tok[index] == 'if'):
            tradutor.append('DSVS L1')
            tradutor.append('L2 IF')
            if(tok[index+2] in numeros):
                tradutor.append('CRCT ' +tok[index + 2])
            else:
                tradutor.append('CRVL ' +tok[index + 2])
            ...
            if(tok[index+3] in simbolos_compostos):
                if(tok[index+3] == '<='):
                    ...
                    tradutor.append('DISJ')
            tradutor.append('DSVF L3')

        elif(tok[index] == 'else'):
            tradutor.append('DSVS L2')
            tradutor.append('L3 ELSE')
        ...
        if(not chave and quantidade_variavel != 0):        
            tradutor.append('DMEM ' +str(quantidade_variavel))
            tradutor.append('PARA')
    pprint(tradutor)
